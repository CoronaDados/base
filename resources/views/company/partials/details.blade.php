<div class="col-lg-12 pl-0 pt-0 pr-0 details" data-person-name="{{ $personName }}">
    ...
    <div class="nav-wrapper pt-0">
        <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-text" role="tablist">
            <li class="nav-item">
                <a class="nav-link mb-sm-3 mb-md-0 active" id="monitoramento-tab" data-toggle="tab"
                    href="#monitoramento-text" role="tab" aria-controls="monitoramento-text"
                    aria-selected="true">Histórico de Monitoramento</a>
            </li>
            <li class="nav-item">
                <a class="nav-link mb-sm-3 mb-md-0" id="diagnostico-tab" data-toggle="tab" href="#diagnostico-text"
                    role="tab" aria-controls="diagnostico-text" aria-selected="false">Histórico de Diagnóstico</a>
            </li>
        </ul>
    </div>
    @endisset
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade active show" id="monitoramento-text" role="tabpanel"
            aria-labelledby="monitoramento-tab">
                ...
                <div class="timeline-block">
                    ...
                    <div class="timeline-content">
                        ...
                        <p class=" text-sm mt-1 mb-0 obs-monitoring">
                            {{ $monitoring->notes ?? 'Não foi cadastrado nenhuma observação.'}}
                        </p>

                        @if($monitoring->symptoms)
