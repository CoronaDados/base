    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li
                    class="nav-item {{( request()->is('person*') || request()->segment(1) === 'roles') ? 'active' : ''}}">
                    ...
                    <div class="collapse {{ request()->is('person*') || request()->segment(1) === 'roles' ? 'show' : ''}}"
                        id="navbar-colaboradores">
                ...
                <li class="nav-item {{request()->is('companies/monitoring*') ? 'active' : ''}}">
                    ...
                    <div class="collapse {{request()->is('companies/monitoring*') ? 'show' : ''}}"
